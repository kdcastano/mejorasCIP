...
if($_SESSION['planta'] == "13"){
  abstract class basedatos{
	
    private $BaseDatos = "qualitic_pruebacontrolproceso";		
    private $Servidor = "localhost";		
    private $Usuario = "qualitic_pruebasCIPUserBD";		
    private $Clave = 'rJQ;ArL,ijdqv+HzUh'; 
...
if($_SESSION['planta'] == "15"){
 abstract class basedatos{
	
    private $BaseDatos = "qualitic_pruebacipotraBD";		
    private $Servidor = "localhost";		
    private $Usuario = "qualitic_pruebacip2BD";		
    private $Clave = '5P*nDM__y?[-.#@q9L'; 
