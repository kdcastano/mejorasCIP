...
/*
Validación antes del 30 de Julio de 2023
if($_POST['turno'] != "-1"){
...
if($_POST['agrupacion'] != '2'){
 ...
 $resPueVar = $resP->respuestasVariablesPanelSupervisorTodasVariables($resEstA2, $cantAreas, $_POST['formato'], $_POST['familia'], $_POST['color'], $FechaInicialRes, $FechaFinalRes, $_POST['puestoTrabajo']);
  ...
  <div class="col-lg-12 col-md-12">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <strong>Center line - <?php echo $_POST['nombreVariable']; if(isset($puestaPunto[$_POST['codigoVariable']])){ echo "<br>"." Puesta punto: ".$puestaPunto[$_POST['codigoVariable']];}  ?></strong>
      </div>
