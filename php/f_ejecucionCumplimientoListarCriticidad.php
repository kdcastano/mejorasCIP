...
$resp = new respuestas();
$resResp = $resp->listarInformeEjecucionCumplimientoCriticidad($fechaInicialCompleta, $fechaFinalCompleta, $_POST['fechaInicial'], $_POST['fechaFinal'], $_POST['areas'], $listaHoras, $CantRegHor, $_POST['puestosTrabajo'], $_POST['tipoVariable'], $_POST['criticidad'], $_POST['turnos']);
...
//var_dump($vectorTurnoOpeExistePrincipal);
