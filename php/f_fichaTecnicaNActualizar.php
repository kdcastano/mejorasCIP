...
-->
            <div class="form-group">
              ...
              <textarea  id="FicT_NombreArchivoAct" class="form-control" cols="10" rows="3" maxlength="200"><?php echo $fic->getFicT_NombreArchivo(); ?></textarea>
            </div>
          </div>
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                      <div class="form-group">
                        ...
                        <?php if($fic->getFicT_Foto() != ""){ ?>
                          <div><button class="btn btn-danger btn-xs e_cargarEliminarFotoFT" data-cod="<?php echo $_POST['codigo']; ?>" data-tip="punzon">Eliminar</button></div>
                        <?php } ?>
                      </div>
                  </div>
                </div>
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                      <div class="form-group">
                        ...
                        <?php if($fic->getFicT_FotoDos() != ""){ ?>
                          <div><button class="btn btn-danger btn-xs e_cargarEliminarFotoFT" data-cod="<?php echo $_POST['codigo']; ?>" data-tip="terminado">Eliminar</button></div>
                        <?php } ?>
                      </div>
                  </div>
                </div>
