...
$var = new variables();
//$resVar = $var->buscarArchivoVariables($_POST['planta']);

$vecArchivoVariables = "";
$vecArchivoVariablesNombre = "";
            ...
            <thead>
              ...
              <tr class="letra14">
                ...
                if ( $respuestaVacioHoraRotura[ $i ] == "3" ) {
                  ...
                  if ( isset( $resultadoDivisionRetalVisual[ $i ] ) && !is_nan( $resultadoDivisionRetalVisual[ $i ] ) ) {
                    ...
                    if ( $cal2->getCal_Operador() == "3" ) {
                      ...
                      $ColValCenterLine = "";
                      if ( number_format( $resultadoDivisionRetalVisual[ $i ], 3, ".", "" ) >= $LVerde1 && number_format( $resultadoDivisionRetalVisual[ $i ], 3, ".", "" ) <= $LVerde2 ) {
                ...
                if ( $respuestaVacioHoraRotura[ $i ] == "3" ) {
                  ...
                  if ( !is_nan( $resultadoDivisionRetalVisual[ $i ] ) ) {
              ...
              <tr>
                ...
                if ( $_POST[ 'area' ] == "-1" ) {
                  if ( isset( $vecNumeroPiezas2[ $registro10[ 0 ] ][ $registro10[ 5 ] ][ $registro10[ 6 ] ][ $registro10[ 7 ] ][ $i ] ) ) {
                    ...
                    $formulaPorcentaje2 = ( $numeroPiezasTotal2 / ( $sumatoriaNumeroPiezasRetalDefectos[ $i ] ) ) * $resultadoDivisionRetalVisual[ $i ];
...
//echo 'La página tard&oacute; '.round($tiempo_ejecucion,1).' segundos en ejecutarse';
?>