...
<!--        <th class="text-center" align="center">FORMATO</th>-->
        ...
        <th class="text-center" align="center"><?php if($usu->getPla_Codigo() == "22"){ echo "PRODUCTO";}else{echo "DESCRIPCIÓN";} ?></th>
...
<!--        <td><?php //echo $registro[2]; ?></td>-->
        ...
        <td><?php 
          if($usu->getPla_Codigo() == "22"){ 
            echo $registro[2]." ".$registro[3]." ".$registro[4];  
          }else{
            if($usu->getPla_Codigo() == "21"){
...
<!--        <td align="right"><?php echo $registro[6]; ?></td>-->
        ...
        <td align="center"><img src="../imagenes/pdf.png" width="25px" class="pdf_exportarFTN manito" data-cod="<?php echo $registro[0]; ?>" data-pla="<?php echo $registro[8]; ?>" data-form="<?php echo $registro[9]; ?>" data-fecha = "<?php echo $registro[5]; ?>" data-prod = "<?php echo $registro[3]." - ".$registro[4]; ?>" title="Exportar a PDF"></td>
