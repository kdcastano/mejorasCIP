  ...
  <div id="d_contenedor" class="container-fluid">
    <div class="details-header_footerECINFEC">
      <div class="details-header_footer_iitemECINFEC">
        ...
        <span class="title letra18">Informe % Ejecución - % Cumplimiento</span>
      </div>
    </div>
    <div class="filtros-container">
      <div class="col-lg-1 col-md-1">
        <div class="form-group">
          ...
          <input type="text" id="filtroREjecucionCumplimiento_FechaInicial" class="form-control fecha" value="<?php if(date("H:i", strtotime($hora)) >= "00:00" && date("H:i", strtotime($hora)) <= "05:59"){ echo date("Y-m-d", strtotime($fecha." - 1 days")); }else{echo $fecha;}  ?>" autocomplete="off">
        </div>
      </div>
      <div class="col-lg-1 col-md-1">
        <div class="form-group">
          <label class="control-label">Hora Inicial:</label>
          <input type="text" id="filtroREjecucionCumplimiento_HoraInicial" class="form-control hora" value="<?php echo $horaInicial; ?>" autocomplete="off">
        </div>
      </div>
      <div class="col-lg-1 col-md-1">
        <div class="form-group">
          <label class="control-label">Fecha Final:</label>
          <input type="text" id="filtroREjecucionCumplimiento_FechaFinal" class="form-control fecha" value="<?php if(date("H:i", strtotime($hora)) >= "00:00" && date("H:i", strtotime($hora)) <= "05:59"){ echo date("Y-m-d", strtotime($fecha." - 1 days")); }else{echo $fecha;}  ?>" autocomplete="off">
        </div>
      </div>
      <div class="col-lg-1 col-md-1">
        <div class="form-group">
          <label class="control-label">Hora Final:</label>
          <input type="text" id="filtroREjecucionCumplimiento_HoraFinal" class="form-control hora" value="<?php echo $horaFinal; ?>" autocomplete="off">
        </div>
      </div>
      <div class="col-lg-2 col-md-2">
        <div class="form-group">
          <label class="control-label">Planta:<span class="rojo">*</span></label>
          <select id="filtroREjecucionCumplimiento_Planta" class="form-control">
      ...
      <div class="col-lg-2 col-md-2">
        <div class="form-group">
          ...
          <select id="filtroREjecucionCumplimiento_TipoArea" class="form-control">
      ...
      <div class="col-lg-2 col-md-2 infoEjeCum_datosAreas">
        <div class="form-group">
      ...
      <div class="col-lg-2 col-md-2 infoEjeCum_datosPuestosTrabajo">
        <div class="form-group">
      ...
      <div class="col-lg-1 col-md-1 infoEjeCumpEst_datosTurnos">
        <div class="form-group">
          <label class="control-label">Turnos:</label>
          <select id="filtroREjecucionCumplimiento_Turno" class="form-control" multiple>
          </select>
        </div>
      </div>
      <div class="col-lg-1 col-md-1">
        <div class="filtros-container-item buscar">
         <button class="btn Btn_CargarDatosEjecucionCumplimiento">Buscar</button>
        </div>
      </div>
      <div class="col-lg-1 col-md-1" align="center">
        <br>
        <form action="op_excelExportacion.php" method="post" id="f_consultaEjeCum" target="_blank">
          <img src="../imagenes/excel.png" width="30" height="30" class="manito" id="b_excelEjeCumBoton">
          <input type="hidden" name="nombre" value="% Ejecución - % Cumplimiento">
          <input type="hidden" name="resultado" id="input_resultadoEjeCum">
        </form>
      </div>
    </div>
    <br><br>
    <div class="info_EjecucionCumplimientoListar">
