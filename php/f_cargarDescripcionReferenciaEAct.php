...
<div class="form-group">
  ...
  <input type="text" id="RefE_DescripcionAct" class="form-control" maxlength="" value="<?php if($usu->getPla_Codigo() == "22"){ echo $resRef[2]." ".$_POST['familia']." ".$_POST['color']; }else{ echo $resRef[0]; } ?>">
</div>